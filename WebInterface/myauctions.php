...
<html>
  ...
  <body>
    <div id="holder">
      ...
      <h1><?php echo $lang['myauctions']['pagetitle']; ?></h1>
      <br/>
      <p style="color:red">
<?php
...
?>
                <div id="new-auction-box">
                        <h2><?php echo $lang['myauctions']['subtitle_new']; ?></h2>
                        <form action="scripts/newAuction.php" method="post" name="auction">
                        <table style="text-align:left;" width="100%">
                        <tr>
                                <td width="50%"><label><?php echo $lang['myauctions']['form_item']; ?></label></td><td width="50%"><select name="Item" class="select">
<?php
...
?>                                </select></td>
                                ...
                                <p>
<?php
                                        if($isAdmin){ echo $lang['myauctions']['form_infinit_msg']; }
?>
                                </p>
                                </td></tr>
                                <tr><td><label><?php echo $lang['myauctions']['form_quantity']; ?>Quantity</label></td><td><input name="Quantity" type="text" class="input" size="10" /></td></tr>
...
?>
        <h2><?php echo $lang['myauctions']['subtitle']; ?></h2>
        <div class="demo_jui">
                <table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
                        <thead>
                                <tr>
                                        <th><?php echo $lang['myauctions']['th_iteminfo']; ?></th>
                                        <th><?php echo $lang['myauctions']['th_expires']; ?></th>
                                        <th><?php echo $lang['myauctions']['th_quantity']; ?></th>
                                        <th><?php echo $lang['myauctions']['th_priceeach']; ?></th>
                                        <th><?php echo $lang['myauctions']['th_pricetotal']; ?></th>
                                        <th><?php echo $lang['myauctions']['th_marketprice']; ?></th>
                                        <th><?php echo $lang['myauctions']['th_cancel']; ?></th>
                                </tr>
                        </thead>
                        <tbody>
<?php
...
?>
                                                ...
                                                <td class="center"><a a class='button' href="scripts/cancelAuction.php?id=<?php echo $id ?>"><?php echo $lang['myauctions']['btn_cancel']; ?></a></td>
                                        </tr>
<?php
                                }
?>
