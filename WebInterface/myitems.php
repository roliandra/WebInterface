...
<html>
        ...
        <div id="holder">
                ...
                <h1><?php echo $lang['myitems']['pagetitle']; ?></h1>
                        <br/>
        <h2><?php echo $lang['myitems']['subtitle']; ?></h2>
...
<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
        <thead>
                <tr>
                        <th><?php echo $lang['myitems']['th_item']; ?></th>
                        <th><?php echo $lang['myitems']['th_quantity']; ?></th>
            <th><?php echo $lang['myitems']['th_marketpriceeach']; ?></th>
                        <th><?php echo $lang['myitems']['th_marketpricetotal']; ?></th>
            <th><?php echo $lang['myitems']['th_mailmeitem']; ?></th>
        ...
        while(list($id, $name, $damage, $player, $quantity)= mysql_fetch_row($queryItems))
    {
        ...
        <tr class="gradeC">
            ...
            <td><a href="scripts/mailItem.php?id=<?php echo $id ?>"><?php echo $lang['myitems']['mailit']; ?></a></td>
