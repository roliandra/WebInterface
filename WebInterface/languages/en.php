...
$lang['newAuction']['success'] = "You auctioned $sellQuantity $itemFullName for $currencyPrefix $sellPrice $currencyPostfix each, the fee was $currencyPrefix $itemFee $currencyPostfix";
$lang['newAuction']['error'] =  "Fee cost $currencyPrefix $itemFee $currencyPostfix , you did not have enough money.";
...
$lang['purchaseItem']['buy_success'] = "You purchased $buyQuantity $auction->fullname from $auction->owner for $currencyPrefix $totalPrice $currencyPostfix .";
